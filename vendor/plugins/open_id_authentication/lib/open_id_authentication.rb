  ...
  private
    ...
    def complete_open_id_authentication
      ...
      when OpenID::Consumer::SUCCESS
        ...
        [ OpenID::SReg::Response, OpenID::AX::FetchResponse, OpenID::OAuthHybrid::Response ].each do |data_response|
    ...
    def add_oauth_fields open_id_request, fields
      return unless fields[:oauth] && fields[:oauth][:consumer_key]
      oauth_request = OpenID::OAuthHybrid::Request.new fields[:oauth].delete(:consumer_key), fields[:oauth].delete(:scope), fields[:oauth].delete(:ns_alias)
